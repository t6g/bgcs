...
co2a  = np.loadtxt('../../simulations/phtem/co2.txt', skiprows=2)
co4a  = np.loadtxt('../../simulations/phtem/co4.txt', skiprows=2)
co8a  = np.loadtxt('../../simulations/phtem/co8.txt', skiprows=2)
cm2a  = np.loadtxt('../../simulations/phtem/cm2.txt', skiprows=2)
cm4a  = np.loadtxt('../../simulations/phtem/cm4.txt', skiprows=2)
cm8a  = np.loadtxt('../../simulations/phtem/cm8.txt', skiprows=2)
ro2a  = np.loadtxt('../../simulations/phtem/ro2.txt', skiprows=2)
ro4a  = np.loadtxt('../../simulations/phtem/ro4.txt', skiprows=2)
ro8a  = np.loadtxt('../../simulations/phtem/ro8.txt', skiprows=2)
rm2a  = np.loadtxt('../../simulations/phtem/rm2.txt', skiprows=2)
rm4a  = np.loadtxt('../../simulations/phtem/rm4.txt', skiprows=2)
rm8a  = np.loadtxt('../../simulations/phtem/rm8.txt', skiprows=2)
to2a  = np.loadtxt('../../simulations/phtem/to2.txt', skiprows=2)
to4a  = np.loadtxt('../../simulations/phtem/to4.txt', skiprows=2)
to8a  = np.loadtxt('../../simulations/phtem/to8.txt', skiprows=2)
tm2a  = np.loadtxt('../../simulations/phtem/tm2.txt', skiprows=2)
tm4a  = np.loadtxt('../../simulations/phtem/tm4.txt', skiprows=2)
tm8a  = np.loadtxt('../../simulations/phtem/tm8.txt', skiprows=2)

co2b  = np.loadtxt('../../simulations/phdlem/co2.txt', skiprows=2)
co4b  = np.loadtxt('../../simulations/phdlem/co4.txt', skiprows=2)
co8b  = np.loadtxt('../../simulations/phdlem/co8.txt', skiprows=2)
cm2b  = np.loadtxt('../../simulations/phdlem/cm2.txt', skiprows=2)
cm4b  = np.loadtxt('../../simulations/phdlem/cm4.txt', skiprows=2)
cm8b  = np.loadtxt('../../simulations/phdlem/cm8.txt', skiprows=2)
ro2b  = np.loadtxt('../../simulations/phdlem/ro2.txt', skiprows=2)
ro4b  = np.loadtxt('../../simulations/phdlem/ro4.txt', skiprows=2)
ro8b  = np.loadtxt('../../simulations/phdlem/ro8.txt', skiprows=2)
rm2b  = np.loadtxt('../../simulations/phdlem/rm2.txt', skiprows=2)
rm4b  = np.loadtxt('../../simulations/phdlem/rm4.txt', skiprows=2)
rm8b  = np.loadtxt('../../simulations/phdlem/rm8.txt', skiprows=2)
to2b  = np.loadtxt('../../simulations/phdlem/to2.txt', skiprows=2)
to4b  = np.loadtxt('../../simulations/phdlem/to4.txt', skiprows=2)
to8b  = np.loadtxt('../../simulations/phdlem/to8.txt', skiprows=2)
tm2b  = np.loadtxt('../../simulations/phdlem/tm2.txt', skiprows=2)
tm4b  = np.loadtxt('../../simulations/phdlem/tm4.txt', skiprows=2)
tm8b  = np.loadtxt('../../simulations/phdlem/tm8.txt', skiprows=2)
...
lgd = plt.legend(('CLM4Me', 'TEM', 'DLEM'),loc=1,numpoints=1)
