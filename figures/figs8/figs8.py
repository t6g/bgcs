...
co2a  = np.loadtxt('../../simulations/century/co2.txt', skiprows=2)
co4a  = np.loadtxt('../../simulations/century/co4.txt', skiprows=2)
co8a  = np.loadtxt('../../simulations/century/co8.txt', skiprows=2)
cm2a  = np.loadtxt('../../simulations/century/cm2.txt', skiprows=2)
cm4a  = np.loadtxt('../../simulations/century/cm4.txt', skiprows=2)
cm8a  = np.loadtxt('../../simulations/century/cm8.txt', skiprows=2)
ro2a  = np.loadtxt('../../simulations/century/ro2.txt', skiprows=2)
ro4a  = np.loadtxt('../../simulations/century/ro4.txt', skiprows=2)
ro8a  = np.loadtxt('../../simulations/century/ro8.txt', skiprows=2)
rm2a  = np.loadtxt('../../simulations/century/rm2.txt', skiprows=2)
rm4a  = np.loadtxt('../../simulations/century/rm4.txt', skiprows=2)
rm8a  = np.loadtxt('../../simulations/century/rm8.txt', skiprows=2)
to2a  = np.loadtxt('../../simulations/century/to2.txt', skiprows=2)
to4a  = np.loadtxt('../../simulations/century/to4.txt', skiprows=2)
to8a  = np.loadtxt('../../simulations/century/to8.txt', skiprows=2)
tm2a  = np.loadtxt('../../simulations/century/tm2.txt', skiprows=2)
tm4a  = np.loadtxt('../../simulations/century/tm4.txt', skiprows=2)
tm8a  = np.loadtxt('../../simulations/century/tm8.txt', skiprows=2)

co2b  = np.loadtxt('../../simulations/ratkowsky/co2.txt', skiprows=2)
co4b  = np.loadtxt('../../simulations/ratkowsky/co4.txt', skiprows=2)
co8b  = np.loadtxt('../../simulations/ratkowsky/co8.txt', skiprows=2)
cm2b  = np.loadtxt('../../simulations/ratkowsky/cm2.txt', skiprows=2)
cm4b  = np.loadtxt('../../simulations/ratkowsky/cm4.txt', skiprows=2)
cm8b  = np.loadtxt('../../simulations/ratkowsky/cm8.txt', skiprows=2)
ro2b  = np.loadtxt('../../simulations/ratkowsky/ro2.txt', skiprows=2)
ro4b  = np.loadtxt('../../simulations/ratkowsky/ro4.txt', skiprows=2)
ro8b  = np.loadtxt('../../simulations/ratkowsky/ro8.txt', skiprows=2)
rm2b  = np.loadtxt('../../simulations/ratkowsky/rm2.txt', skiprows=2)
rm4b  = np.loadtxt('../../simulations/ratkowsky/rm4.txt', skiprows=2)
rm8b  = np.loadtxt('../../simulations/ratkowsky/rm8.txt', skiprows=2)
to2b  = np.loadtxt('../../simulations/ratkowsky/to2.txt', skiprows=2)
to4b  = np.loadtxt('../../simulations/ratkowsky/to4.txt', skiprows=2)
to8b  = np.loadtxt('../../simulations/ratkowsky/to8.txt', skiprows=2)
tm2b  = np.loadtxt('../../simulations/ratkowsky/tm2.txt', skiprows=2)
tm4b  = np.loadtxt('../../simulations/ratkowsky/tm4.txt', skiprows=2)
tm8b  = np.loadtxt('../../simulations/ratkowsky/tm8.txt', skiprows=2)
...
lgd = plt.legend(('CLM-CN', 'CENTURY', 'T$_m$ = 260 $^{\circ}$K'),loc=1,numpoints=1)
