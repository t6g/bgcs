...
co2a  = np.loadtxt('../../simulations/arrhenius/co2.txt', skiprows=2)
co4a  = np.loadtxt('../../simulations/arrhenius/co4.txt', skiprows=2)
co8a  = np.loadtxt('../../simulations/arrhenius/co8.txt', skiprows=2)
cm2a  = np.loadtxt('../../simulations/arrhenius/cm2.txt', skiprows=2)
cm4a  = np.loadtxt('../../simulations/arrhenius/cm4.txt', skiprows=2)
cm8a  = np.loadtxt('../../simulations/arrhenius/cm8.txt', skiprows=2)
ro2a  = np.loadtxt('../../simulations/arrhenius/ro2.txt', skiprows=2)
ro4a  = np.loadtxt('../../simulations/arrhenius/ro4.txt', skiprows=2)
ro8a  = np.loadtxt('../../simulations/arrhenius/ro8.txt', skiprows=2)
rm2a  = np.loadtxt('../../simulations/arrhenius/rm2.txt', skiprows=2)
rm4a  = np.loadtxt('../../simulations/arrhenius/rm4.txt', skiprows=2)
rm8a  = np.loadtxt('../../simulations/arrhenius/rm8.txt', skiprows=2)
to2a  = np.loadtxt('../../simulations/arrhenius/to2.txt', skiprows=2)
to4a  = np.loadtxt('../../simulations/arrhenius/to4.txt', skiprows=2)
to8a  = np.loadtxt('../../simulations/arrhenius/to8.txt', skiprows=2)
tm2a  = np.loadtxt('../../simulations/arrhenius/tm2.txt', skiprows=2)
tm4a  = np.loadtxt('../../simulations/arrhenius/tm4.txt', skiprows=2)
tm8a  = np.loadtxt('../../simulations/arrhenius/tm8.txt', skiprows=2)

co2b  = np.loadtxt('../../simulations/q10/co2.txt', skiprows=2)
co4b  = np.loadtxt('../../simulations/q10/co4.txt', skiprows=2)
co8b  = np.loadtxt('../../simulations/q10/co8.txt', skiprows=2)
cm2b  = np.loadtxt('../../simulations/q10/cm2.txt', skiprows=2)
cm4b  = np.loadtxt('../../simulations/q10/cm4.txt', skiprows=2)
cm8b  = np.loadtxt('../../simulations/q10/cm8.txt', skiprows=2)
ro2b  = np.loadtxt('../../simulations/q10/ro2.txt', skiprows=2)
ro4b  = np.loadtxt('../../simulations/q10/ro4.txt', skiprows=2)
ro8b  = np.loadtxt('../../simulations/q10/ro8.txt', skiprows=2)
rm2b  = np.loadtxt('../../simulations/q10/rm2.txt', skiprows=2)
rm4b  = np.loadtxt('../../simulations/q10/rm4.txt', skiprows=2)
rm8b  = np.loadtxt('../../simulations/q10/rm8.txt', skiprows=2)
to2b  = np.loadtxt('../../simulations/q10/to2.txt', skiprows=2)
to4b  = np.loadtxt('../../simulations/q10/to4.txt', skiprows=2)
to8b  = np.loadtxt('../../simulations/q10/to8.txt', skiprows=2)
tm2b  = np.loadtxt('../../simulations/q10/tm2.txt', skiprows=2)
tm4b  = np.loadtxt('../../simulations/q10/tm4.txt', skiprows=2)
tm8b  = np.loadtxt('../../simulations/q10/tm8.txt', skiprows=2)
...
lgd = plt.legend(('CLM-CN', 'E$_a$ = 60', 'Q10 = 2.5'),loc=1,numpoints=1)
