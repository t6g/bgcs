...
CALCULATE_VALUES
 ...
 30 pHopt = 7.0
 40 pHmax = 10.0
 50 fpH = (pH - pHmin) * (pH - pHmax) / ((pH - pHmin) * (pH - pHmax) - (pH - pHopt) * (pH - pHopt))
 55 if fpH < 0.0 then fpH = 0.0
 60 SAVE fpH
 -end
...
USER_PUNCH
  -start
  -heading Time(d) pH P(atm) CO2(g) CH4(g) H2(g) CO2(a) CH4(a) H2(a) Ac Glucose Fulvic WEOC Fe(2) Fe(3) CO2(gmole) CH4(gmole) CO2s(mole) Fe(OH)3a SOM1 SOM2 SOM3 SOM4 FeRb MeGAb MeGHb Ac- Fe+2 Fe+3 H2 fpH
